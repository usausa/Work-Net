...
dotnet publish WorkPlugin.Service/WorkPlugin.Service.csproj -c Release -f net10.0 /p:BuildPlatform=linux -r win-x64 --self-contained -p:PublishSingleFile=true -o publish/linux-x64
dotnet publish WorkPlugin.Service/WorkPlugin.Service.csproj -c Release -f net10.0 /p:BuildPlatform=osx -r win-x64 --self-contained -p:PublishSingleFile=true -o publish/osx-x64
