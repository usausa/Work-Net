...
internal sealed class SmartNvme : ISmartNvme, IDisposable
{
    ...
    public unsafe bool Update()
    {
        ...
        try
        {
            var smartLog = new nvme_smart_log();
            ...
            DataUnitRead = Le128ToU64(smartLog.data_units_read);
            DataUnitWritten = Le128ToU64(smartLog.data_units_written);
            HostReadCommands = Le128ToU64(smartLog.host_reads);
            HostWriteCommands = Le128ToU64(smartLog.host_writes);
            ControllerBusyTime = Le128ToU64(smartLog.ctrl_busy_time);
            ...
            ErrorInfoLogEntries = Le128ToU64(smartLog.num_err_log_entries);
    ...
    private static unsafe ulong Le128ToU64(byte* p)
    {
        ulong v = 0;
        for (var i = 7; i >= 0; i--)
        {
