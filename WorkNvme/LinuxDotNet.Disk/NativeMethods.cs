...
internal static class NativeMethods
{
    ...
    // Linux major numbers
    public const int MajorNvme = 259;
    public const int MajorScsi = 8;
    public const int MajorIde1 = 3;
    public const int MajorIde2 = 22;
    public const int MajorMmc = 179;
    public const int MajorVirtIO = 252;
