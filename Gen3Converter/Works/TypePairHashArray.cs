namespace Works
{
    ...
    public sealed class TypePairHashArray
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryGetValueInternal(Table targetTable, Type sourceType, Type targetType, out Delegate value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool TryGetValue(Type sourceType, Type targetType, out Delegate converter)
        {
            return TryGetValueInternal(table, sourceType, targetType, out converter);
        }

        public Delegate AddIfNotExist(Type sourceType, Type targetType, Func<Type, Type, Delegate> valueFactory)
        {
            lock (sync)
            {
        ...
        private class Node
        {
            ...
            public Node(Type sourceType, Type targetType, Delegate converter)
            {
