...
### [FighterHud](FighterHud/README.md)

戦闘機のタクティカル HUD「FIGHTER HUD」。方位 / 速度 / 高度テープ、ロール連動のピッチラダー、
レーダー、兵装パネル、目標ロックボックスを備え、疑似フライトシミュレーションで全計器が自動で動きます。

[<img src="FighterHud/screenshot.png" width="640" alt="FighterHud">](FighterHud/README.md)

### [MechHud](MechHud/README.md)

FighterHud をベースにした陸戦人型機動兵器（メカ）向けの HUD。グリーンフォスファー調で、
移動モード遷移・推進剤・部位ダメージ・左右武装切替・通信回線・等高線戦術マップ・中隊編成を表示します。

[<img src="MechHud/screenshot.png" width="640" alt="MechHud">](MechHud/README.md)

### [TacticalArmorHud](TacticalArmorHudOld/README.md)

戦術機（TSF 風）コックピット HUD。シアン / ティール基調で、真上視点レーダー・等高線戦術マップ・
中央左右のデュアル高度テープ・機体 8 部位ダメージ表示・左右アームの 3 兵装切替を備えます。
