namespace Smart.Collections.Concurrent
{
    ...
    public sealed class ThreadsafeTypeHashArrayMapOld<TValue> : IEnumerable<KeyValuePair<Type, TValue>>
    {
        ...
        public ThreadsafeTypeHashArrayMapOld(int initialSize = 64, double factor = 1.5)
            : this(new GrowthHashArrayMapStrategy(initialSize, factor))
        {
        }

        public ThreadsafeTypeHashArrayMapOld(IHashArrayMapStrategy strategy)
        {
