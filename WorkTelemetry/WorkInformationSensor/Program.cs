namespace WorkInformationSensor;
...
internal static class Program
{
    ...
    {
        var sensor = new Sensor("COM12", 30_0000);
        sensor.Update();
...
#pragma warning restore IDE0055
    ...
    public Sensor(string portName, long expire)
    {
    ...
    public void Update()
    {
        lock (sync)
        {
            ...
            var tick = timestamp - lastTick;
            var ms = (tick / Stopwatch.Frequency) * 1000;
            if (ms < expire)
            {
                return;
            }
