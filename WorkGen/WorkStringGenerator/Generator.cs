...
public sealed class Generator : IIncrementalGenerator
{
    ...
    private static void Execute(SourceProductionContext context, Compilation compilation, ImmutableArray<ClassDeclarationSyntax> classes)
    {
        ...
        foreach (var classDeclarationSyntax in classes)
        {
            ...
            var ns = String.IsNullOrEmpty(classSymbol.ContainingNamespace.Name)
                ? string.Empty
            ...
            buffer.AppendLine("        {");
            // TODO Optimize
            buffer.AppendLine("            var handler = new global::System.Runtime.CompilerServices.DefaultInterpolatedStringHandler(0, 0);");
